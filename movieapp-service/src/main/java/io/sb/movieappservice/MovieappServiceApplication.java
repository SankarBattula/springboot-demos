package io.sb.movieappservice;

import io.sb.movieappservice.services.CityService;
import io.sb.movieappservice.services.TheatreService;
...
public class MovieappServiceApplication {
    ...
    public static void main(String[] args) {
        ...
        ApplicationContext context = SpringApplication.run(MovieappServiceApplication.class, args);
