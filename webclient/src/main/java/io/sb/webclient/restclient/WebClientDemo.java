package io.sb.webclient.restclient;

import io.sb.webclient.dtos.IdeaDTO;
...
public class WebClientDemo {
    ...
    IdeaDTO ideaDTO = new IdeaDTO(2, "New Idea", "New Idea Description", "Vishwa Mohan");
     ...
     * Delete an idea
     */
    Mono<IdeaDTO> deletedIdea = webClient.delete().uri("/demo_app/v1/ideas/121").retrieve().bodyToMono(IdeaDTO.class);
